...
using eShop.Application.Core.Services.Interfaces;
using System;
...
namespace eShop.Application.Core.Services
{
    public class OrderService : IOrderService
    {
        public bool ValidateCustomerInformation(string name, string address, string city,
